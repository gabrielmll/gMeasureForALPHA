...
#ifndef MIN_UTILITY_H_
#define MIN_UTILITY_H_
...
class MinUtility: public TupleMeasure
{
 public:
  MinUtility(const string& tupleValueFileName, const char* dimensionSeparator, const char* elementSeparator, const vector<unordered_map<string, unsigned int>>& labels2Ids, const vector<unsigned int>& dimensionOrder, const vector<unsigned int>& cardinalities, const float densityThreshold, const float threshold);
  MinUtility* clone() const;
